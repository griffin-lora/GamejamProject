...
export var castle_texture : StreamTexture
export var castle_particle_texture : StreamTexture
...
func _ready():
	...
	if GlobalVars.level_data.theme == 1:
		...
		sprite.texture = castle_texture
		particles.texture = castle_particle_texture
